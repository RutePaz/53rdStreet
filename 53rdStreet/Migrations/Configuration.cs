namespace _53rdStreet.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<_53rdStreet.Models.MusicalDB>
    {
        ...
        protected override void Seed(_53rdStreet.Models.MusicalDB context)
        {
            //*********************************************************************
            // add Musicals
  ...
  new Cast {ID_Actor=1, Name="Dashaun Young",  ListMusical=new List<CastMusical>{ musical[0]}},
  new Cast {ID_Actor=2, Name="L. Steven Taylor",ListMusical=new List<CastMusical>{ musical[0]}},
  new Cast {ID_Actor=3, Name="Adrienne Walker",ListMusical=new List<CastMusical>{ musical[0]}},
  new Cast {ID_Actor=4, Name="Tshidi Manye", ListMusical=new List<CastMusical>{ musical[0]}},
  new Cast {ID_Actor=5, Name="Jordan Toure" , ListMusical=new List<CastMusical>{ musical[0]}},
  new Cast {ID_Actor=6, Name="Stephen Carlile",  ListMusical=new List<CastMusical>{ musical[0]}},
  new Cast {ID_Actor=7, Name="Aliyah Mastin", ListMusical=new List<CastMusical>{ musical[0]}},
  new Cast {ID_Actor=8, Name="Cameron Pow",  ListMusical=new List<CastMusical>{ musical[0]}},
  new Cast {ID_Actor=9, Name="Ben Jeffrey",  ListMusical=new List<CastMusical>{ musical[0]}},
  new Cast {ID_Actor=10, Name="Fred Berman", ListMusical=new List<CastMusical>{ musical[0]}},
  new Cast {ID_Actor=11, Name="Bonita J. Hamilton", ListMusical=new List<CastMusical>{ musical[0]}},


  new Cast {ID_Actor=12, Name="Jackie Burns",ListMusical=new List<CastMusical>{ musical[1]}},
  new Cast {ID_Actor=13, Name="Amanda Jane Cooper",  ListMusical=new List<CastMusical>{ musical[1]}},
  new Cast {ID_Actor=14, Name="Ashley Parker Angel",  ListMusical=new List<CastMusical>{ musical[1]}},
  new Cast {ID_Actor=15, Name="P.J. Benjamin",  ListMusical=new List<CastMusical>{ musical[1]}},
  new Cast {ID_Actor=16, Name="Kristen Martin",ListMusical=new List<CastMusical>{ musical[1]}},
  new Cast {ID_Actor=17, Name="Isabel Keating", ListMusical=new List<CastMusical>{ musical[1]}},
  new Cast {ID_Actor=18, Name="Jye Frasca",  ListMusical=new List<CastMusical>{ musical[1]}},
  new Cast {ID_Actor=19, Name="Martin Moran",  ListMusical=new List<CastMusical>{ musical[1]}},


  new Cast {ID_Actor=20, Name="Adam Kaplan",ListMusical=new List<CastMusical>{ musical[2]}},
  new Cast {ID_Actor=21, Name="Richard H. Blake", ListMusical=new List<CastMusical>{ musical[2]}},
  new Cast {ID_Actor=22, Name="Nick Cordero",  ListMusical=new List<CastMusical>{ musical[2]}},
  new Cast {ID_Actor=23, Name="Christiani Pitts", ListMusical=new List<CastMusical>{ musical[2]}},
  new Cast {ID_Actor=24, Name="Bradley Gibson", ListMusical=new List<CastMusical>{ musical[2]}},
  new Cast {ID_Actor=25, Name="Lucia Giannetta",  ListMusical=new List<CastMusical>{ musical[2]}},
  new Cast {ID_Actor=26, Name="Will Coombs",  ListMusical=new List<CastMusical>{ musical[2]}},



  new Cast {ID_Actor=27, Name="Taylor Trensch",  ListMusical=new List<CastMusical>{ musical[3]}},
  new Cast {ID_Actor=28, Name="Jennifer Laura Thompson", ListMusical=new List<CastMusical>{ musical[3]}},
  new Cast {ID_Actor=29, Name="Rachel Bay Jones",  ListMusical=new List<CastMusical>{ musical[3]}},
  new Cast {ID_Actor=30, Name="Michael Park", ListMusical=new List<CastMusical>{ musical[3]}},
  new Cast {ID_Actor=31, Name="Laura Dreyfuss",  ListMusical=new List<CastMusical>{ musical[3]}},
  new Cast {ID_Actor=32, Name="Mike Faist",  ListMusical=new List<CastMusical>{ musical[3]}},
  new Cast {ID_Actor=33, Name="Will Roland",  ListMusical=new List<CastMusical>{ musical[3]}},
  new Cast {ID_Actor=34, Name="Phoenix Best",  ListMusical=new List<CastMusical>{ musical[3]}},



  new Cast {ID_Actor=35, Name="Jonathan Groff ",ListMusical=new List<CastMusical>{ musical[4]}},
  new Cast {ID_Actor=36, Name=" Lea Michele",  ListMusical=new List<CastMusical>{ musical[4]}},
  new Cast {ID_Actor=37, Name="John Gallagher Jr.",  ListMusical=new List<CastMusical>{ musical[4]}},
  new Cast {ID_Actor=38, Name="Stephen SpinellstMa", ListMusical=new List<CastMusical>{ musical[4]}},
  new Cast {ID_Actor=39, Name="Christine Estabrook",  ListMusical=new List<CastMusical>{ musical[4]}},
  new Cast {ID_Actor=40, Name="Lauren Pritchard", ListMusical=new List<CastMusical>{ musical[4]}},
  new Cast {ID_Actor=41, Name="Skylar Astin", ListMusical=new List<CastMusical>{ musical[4]}},
  new Cast {ID_Actor=42, Name="Lilli Cooper",  ListMusical=new List<CastMusical>{ musical[4]}},
  new Cast {ID_Actor=43, Name="Gideon Glick", ListMusical=new List<CastMusical>{ musical[4]}},
  new Cast {ID_Actor=44, Name="Brian Charles Johnson", ListMusical=new List<CastMusical>{ musical[4]}},
  new Cast {ID_Actor=45, Name="Phoebe Strole", ListMusical=new List<CastMusical>{ musical[4]}},
  new Cast {ID_Actor=46, Name="Jonathan B. Wright",  ListMusical=new List<CastMusical>{ musical[4]}},
  new Cast {ID_Actor=47,Name="Remy Zaken",  ListMusical=new List<CastMusical>{ musical[4]}},



  new Cast {ID_Actor=48, Name="Robin Lake", ListMusical=new List<CastMusical>{ musical[5]}},
  new Cast {ID_Actor=49, Name="Dean Ambrose",  ListMusical=new List<CastMusical>{ musical[5]}},
  new Cast {ID_Actor=50, Name="Rory Furkey King", ListMusical=new List<CastMusical>{ musical[5]}},
  new Cast {ID_Actor=51, Name="Tony McGill",ListMusical=new List<CastMusical>{ musical[5]}},
  new Cast {ID_Actor=52, Name="Bruce Aguilar-Rohan", ListMusical=new List<CastMusical>{ musical[5]}},
  new Cast {ID_Actor=53, Name="Nell Martin", ListMusical=new List<CastMusical>{ musical[5]}},
  new Cast {ID_Actor=54, Name="Fletcher Dobinson", ListMusical=new List<CastMusical>{ musical[5]}},
  new Cast {ID_Actor=55, Name="Ella Nonini",  ListMusical=new List<CastMusical>{ musical[5]}},
  new Cast {ID_Actor=56, Name="Joanna Ampil", ListMusical=new List<CastMusical>{ musical[5]}},
  new Cast {ID_Actor=57, Name="Elizabeth Futter", ListMusical=new List<CastMusical>{ musical[5]}},
  new Cast {ID_Actor=58, Name="Grace Swaby",ListMusical=new List<CastMusical>{ musical[5]}},



  new Cast {ID_Actor=59, Name="Elder Price",  ListMusical=new List<CastMusical>{ musical[6]}},
  new Cast {ID_Actor=60, Name="Elder Cunningham",  ListMusical=new List<CastMusical>{ musical[6]}},
  new Cast {ID_Actor=61, Name="Nabulungi",  ListMusical=new List<CastMusical>{ musical[6]}},
  new Cast {ID_Actor=62, Name="Elder McKinley", ListMusical=new List<CastMusical>{ musical[6]}},
  new Cast {ID_Actor=63, Name="Mafala Hatimbi", ListMusical=new List<CastMusical>{ musical[6]}},




  new Cast {ID_Actor=64, Name="Mickey Calin ",  ListMusical=new List<CastMusical>{ musical[7]}},
  new Cast {ID_Actor=65, Name="Larry Kert ",ListMusical=new List<CastMusical>{ musical[7]}},
  new Cast {ID_Actor=66, Name="Carol Lawrence ", ListMusical=new List<CastMusical>{ musical[7]}},
  new Cast {ID_Actor=67, Name="Ken Le Roy ", ListMusical=new List<CastMusical>{ musical[7]}},
  new Cast {ID_Actor=68, Name="Chita Rivera ",  ListMusical=new List<CastMusical>{ musical[7]}},
  new Cast {ID_Actor=69, Name="Art Smith ",ListMusical=new List<CastMusical>{ musical[7]}},



  new Cast {ID_Actor=70, Name="Robert Alda", ListMusical=new List<CastMusical>{ musical[8]}},
  new Cast {ID_Actor=71, Name="Isabel Bigley", ListMusical=new List<CastMusical>{ musical[8]}},
  new Cast {ID_Actor=72, Name=" Vivian Blaine ",  ListMusical=new List<CastMusical>{ musical[8]}},
  new Cast {ID_Actor=73, Name="Sam Levene ",ListMusical=new List<CastMusical>{ musical[8]}},
  new Cast {ID_Actor=74, Name="Pat Rooney ",  ListMusical=new List<CastMusical>{ musical[8]}},
  new Cast {ID_Actor=75, Name="B.S. Pully ",  ListMusical=new List<CastMusical>{ musical[8]}},
  new Cast {ID_Actor=76, Name="Tom Pedi ",  ListMusical=new List<CastMusical>{ musical[8]}},
  new Cast {ID_Actor=77, Name="Stubby Kaye ",  ListMusical=new List<CastMusical>{ musical[8]}},



  new Cast {ID_Actor=78, Name="Lin-Manuel Miranda",  ListMusical=new List<CastMusical>{ musical[9]}},
  new Cast {ID_Actor=79, Name="Leslie Odom, Jr.", ListMusical=new List<CastMusical>{ musical[9]}},
  new Cast {ID_Actor=80, Name="Phillipa Soo",  ListMusical=new List<CastMusical>{ musical[9]}},
  new Cast {ID_Actor=81, Name="Renée Elise Goldsberry",  ListMusical=new List<CastMusical>{ musical[9]}},
  new Cast {ID_Actor=82, Name="Daveed Diggs",  ListMusical=new List<CastMusical>{ musical[9]}},
  new Cast {ID_Actor=83, Name="Christopher Jackson", ListMusical=new List<CastMusical>{ musical[9]}},
  new Cast {ID_Actor=84, Name="Brian d'Arcy James",  ListMusical=new List<CastMusical>{ musical[9]}},
  new Cast {ID_Actor=85, Name="Anthony Ramos", ListMusical=new List<CastMusical>{ musical[9]}},
  new Cast {ID_Actor=86, Name="Jasmine Cephas Jones",  ListMusical=new List<CastMusical>{ musical[9]}}
};
  ...
  new User {ID_User=6,Username="Jeremy Saunders",Email="jeremy.p.saunders@gmail.com"}
            ...
            var CastMusical = new List<CastMusical>
            {
               ...
               new CastMusical {CastFK=34, MusicalFK=4, Character="Alana" },
                ...
                new CastMusical {CastFK=59, MusicalFK=7, Character="Dave Thomas Brown" },
                new CastMusical {CastFK=60, MusicalFK=7, Character="Cody Jamison Strand" },
                new CastMusical {CastFK=61, MusicalFK=7, Character="Nikki Renée Daniels" },
                new CastMusical {CastFK=62, MusicalFK=7, Character="Stephen Ashfield" },
                new CastMusical {CastFK=63, MusicalFK=7, Character="Billy Eugene Jones" },
